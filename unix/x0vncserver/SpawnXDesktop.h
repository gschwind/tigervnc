...
#ifndef __SPAWNXDESKTOP_H__
#define __SPAWNXDESKTOP_H__
...
class SpawnXDesktop : public rfb::SDesktop,
                 public TXGlobalEventHandler,
                 public QueryResultCallback
{
public:
  SpawnXDesktop(Display* dpy_, Geometry *geometry);
  virtual ~SpawnXDesktop();
  void poll();
  // -=- SDesktop interface
